...
<main id="content">
  ...
  <div class="body__wrapper">
	...
	<div class="video-container">
	  <iframe width="100%" height="700" src="https://www.youtube.com/embed/h-OThXvdMRA?autoplay=1&controls=0&playlist=h-OThXvdMRA&showinfo=0&autohide=1&loop=1&mute=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div>
	</div>
